...
<head>
  ...
  (function(){try{if(typeof window==='undefined')return;var ua=navigator.userAgent||'';var ref=document.referrer||'';window.__IS_TWITTER__=ua.indexOf('Twitter')!==-1||ua.indexOf('TwitterAndroid')!==-1||ref.indexOf('t.co')!==-1||ref.indexOf('twitter.com')!==-1||ref.indexOf('x.com')!==-1;window.__IS_INSTAGRAM__=ua.indexOf('Instagram')!==-1||ua.indexOf('FBAN')!==-1||ua.indexOf('FBAV')!==-1;window.__IS_INAPP__=window.__IS_INSTAGRAM__||ua.indexOf('TikTok')!==-1||ua.indexOf('LinkedInApp')!==-1||ua.indexOf('Threads')!==-1||ua.indexOf('Barcelona')!==-1||ref.indexOf('threads.net')!==-1;window.__IS_IOS__=/iPhone|iPad|iPod/i.test(ua);window.__IS_ANDROID__=/Android/i.test(ua);if(window.__IS_TWITTER__){var s=location.href.replace(/^https?:\/\//,'');if(window.__IS_IOS__){location.href='x-safari-https://'+s}else if(window.__IS_ANDROID__){location.href='intent://'+location.hostname+location.pathname+location.search+'#Intent;scheme=https;package=com.android.chrome;end'}}}catch(e){}})();
  </script>
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
