...
<head>
  ...
  (function(){try{if(typeof window==='undefined')return;var ua=navigator.userAgent||'';var ref=document.referrer||'';var forceInApp=${forceInApp ? 'true' : 'false'};var isSnapchatWebView=(ua.indexOf('iPhone')!==-1||ua.indexOf('iPad')!==-1)&&ua.indexOf('Mobile/')!==-1&&ua.indexOf('Safari')===-1&&ua.indexOf('CriOS')===-1&&ua.indexOf('FxiOS')===-1;window.__IS_INAPP__=forceInApp||ua.indexOf('Instagram')!==-1||ua.indexOf('FBAN')!==-1||ua.indexOf('FBAV')!==-1||ua.indexOf('TikTok')!==-1||ua.indexOf('LinkedInApp')!==-1||ua.indexOf('Twitter')!==-1||ua.indexOf('TwitterAndroid')!==-1||ua.indexOf('Threads')!==-1||ua.indexOf('Barcelona')!==-1||ua.indexOf('Snapchat')!==-1||ua.indexOf('snapchat')!==-1||isSnapchatWebView||ref.indexOf('t.co')!==-1||ref.indexOf('twitter.com')!==-1||ref.indexOf('x.com')!==-1||ref.indexOf('threads.net')!==-1||ref.indexOf('snapchat.com')!==-1||ref.indexOf('reddit.com')!==-1||ref.indexOf('redd.it')!==-1;window.__IS_IOS__=/iPhone|iPad|iPod/i.test(ua);window.__IS_ANDROID__=/Android/i.test(ua);window.__FORCE_INAPP__=forceInApp;if(forceInApp&&(window.__IS_IOS__||window.__IS_ANDROID__)){var url=window.location.href;if(url.indexOf('browser=1')===-1){var newUrl=url+(url.indexOf('?')!==-1?'&':'?')+'browser=1';if(window.__IS_IOS__){setTimeout(function(){window.location.href='googlechrome://'+newUrl.replace(/^https?:\\/\\//,'')},50);setTimeout(function(){var s=newUrl.replace(/^https?:\\/\\//,'');window.location.href='x-safari-https://'+s},150)}else{var h=window.location.hostname;var p=window.location.pathname+window.location.search+'&browser=1';var intent='intent://'+h+p+'#Intent;scheme=https;package=com.android.chrome;end';setTimeout(function(){window.location.href=intent},50)}}}}catch(e){}})();
  </script>
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
