...
<head>
  ...
  (function(){try{if(typeof window==='undefined')return;var ua=navigator.userAgent||'';var ref=document.referrer||'';window.__IS_THREADS__=ua.indexOf('Threads')!==-1||ua.indexOf('Barcelona')!==-1||ref.indexOf('threads.net')!==-1;window.__IS_INAPP__=!window.__IS_THREADS__&&(ua.indexOf('Instagram')!==-1||ua.indexOf('FBAN')!==-1||ua.indexOf('FBAV')!==-1||ua.indexOf('TikTok')!==-1||ua.indexOf('LinkedInApp')!==-1||ua.indexOf('Twitter')!==-1||ua.indexOf('TwitterAndroid')!==-1||ref.indexOf('t.co')!==-1||ref.indexOf('twitter.com')!==-1||ref.indexOf('x.com')!==-1);window.__IS_IOS__=/iPhone|iPad|iPod/i.test(ua);window.__IS_ANDROID__=/Android/i.test(ua);if(window.__IS_THREADS__){try{var url=new URL(window.location.href);if(!url.searchParams.has('browser')){url.searchParams.set('browser','1');history.replaceState(null,'',url.toString())}}catch(e){}}}catch(e){}})();
  </script>
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
